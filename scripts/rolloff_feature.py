...
def write_rolloff_to_json(tracks, region):
    ...
    files_rolloff = get_files_rolloff(tracks)
    for obj in input_json:
        position = obj['position']
        obj['rolloff'] = files_rolloff[position].tolist()
...
def main():
    ...
    if argc == 1:
        ...
        if region.lower() == 'us':
            ...
            write_rolloff_to_json(tracks, region.lower())
